...
trait CertbotWebrootOptions
{
     ...
     * -w / -d entries. At present, if you put webroot-map in a config file,
     * it needs to be on a single line, like: webroot-map = {"example.com":"/var/www"}.
     *
     * (default: {})
     *
     * @var string|null
     */
    public ?string $webrootMap ;

    /**
     * public_html / webroot path.
     * This can be specified multiple times to handle different domains;
     * each domain will have the webroot path that preceded it.
